...
For example, the default keyword to trigger the Wikipedia custom search engine, you have to type `wikipedia.org star wars`. However, by using short, memorable keywords, you can reduce the keystrokes significantly. Using the configuration below, I would just type `w star wars` or `wiki star wars` and I would land on the right pages without having to go through google and click on the first result.
...
| allintitle:documentation | doc | https://www.google.com.sg/search?ei=\_JJAWsTPD8P9vgTy-YegDg&q=allintitle%3Adocumentation+%s&oq=allintitle%3Adocumentation+%s&gs\_l=psy-ab.3...14992.16188.0.16434.6.6.0.0.0.0.59.311.6.6.0....0...1c.1.64.psy-ab..0.0.0....0.XZNhqGn6AfA | Quickly search for documentation for prog lang, libraries etc. |
...
| deviantart.com | da  | http://browse.deviantart.com/?qh=§ion=&q=%s |     |
...
| userstyles.org | userstyles | https://userstyles.org/styles/browse\_r?search\_terms=%s |     |
