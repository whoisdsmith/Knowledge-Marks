...
Tags: ["#Type/Code/SQL", "#Topic/Dev/SQL"]
Alias: ["SQL Server Data Dictionary Script"]
---

# MSSQL - Data Dictionary Generator

*Source: [sql_scripts/data_dict_dump.sql at main · DataResearchLabs/sql_scripts · GitHub](https://github.com/DataResearchLabs/sql_scripts/blob/main/mssql/data_dictionary/data_dict_dump.sql)*
